<%@ Page Title="帐号管理" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="Partners.aspx.cs" Inherits="VPC_2014_V001.VPC.Admin.Partners" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" OnItemCommand="Repeater1_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><a target="_blank" href='/Customer/ShopPds?iShopId=<%# DataBinder.Eval(Container.DataItem, "iShopId") %>'><%# DataBinder.Eval(Container.DataItem, "sShopName") %></a></td>
                    ...
                    <td><%# DataBinder.Eval(Container.DataItem, "iLevel") %></td>
