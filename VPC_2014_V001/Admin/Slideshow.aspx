<%@ Page Title="幻灯片管理" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="Slideshow.aspx.cs" Inherits="VPC_2014_V001.VPC.Admin.Slideshow" %>
        ...
        <!-- Button trigger modal -->
         <div class="form-group form-group-min">
            ...
            <div class="ol-md-4">
                ...
                <a href="AddSlideshow?urlreferrer=<%=StringEncode("/Admin/Slideshow")%>&operate=<%=StringEncode("add")%>" class="btn btn-danger">添加</a>
            </div>
        </div>
        <!-- Modal -->
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        ...
                        <a href='/Admin/AddSlideshow?islideshow=<%# DataBinder.Eval(Container.DataItem, "ID") %>&urlreferrer=<%=StringEncode("/Admin/Slideshow")%>&operate=<%=StringEncode("view")%>' class="btn btn-primary" role="button">查看</a>
