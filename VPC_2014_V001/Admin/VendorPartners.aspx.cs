...
{
    public partial class VendorPartners : P_Base
    {
        ...
        {
            var _info = new tbUserTypeRefUser() { iUserTypeId=3001};
        ...
        {
            string _where = string.Empty, _sort = "a.iShopId desc";
            ...
            _paging.Fields = "a.iShopId,a.sShopName,a.cOwnerName,a.cOwnerMail,b.sLoginId,a.iUserId,a.dDate,c.iStatus,d.sStatus";
...
INNER JOIN tbUserTypeRefUser AS c ON a.iUserId=c.iUserId AND c.iUserTypeId=3001
