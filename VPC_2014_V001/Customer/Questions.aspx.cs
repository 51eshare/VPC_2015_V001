...
{
    public partial class Questions :P_Base
    {
        ...
        {
            string _where = "a.iUserId=" + UserInfo.RealID, _sort = "a.iQuestionId desc";
            ...
            if (!string.IsNullOrWhiteSpace(numberno.Text))
                _where += string.IsNullOrWhiteSpace(_where) ? string.Concat("a.bTopic='", numberno.Text.Trim(), "'") : string.Concat(" and a.bTopic='", numberno.Text.Trim(), "'");
