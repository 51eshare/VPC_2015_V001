<%@ Page Title="订单" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="pickCommission.aspx.cs" Inherits="VPC_2014_V001.VPC.Customer.pickCommission" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row text-center">
                    <asp:Button ID="search" CssClass="btn btn-primary" OnClientClick="return check_price();" OnClick="btn_search_ServerClick" runat="server" Text="提现" />
                    <a href="Commissionlist" class="btn btn-primary hidden">现金清单</a>
                </div>
            </div>
            <!-- /input-group -->
