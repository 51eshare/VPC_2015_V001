...
namespace VPC_2014_V001
{
    public partial class FullSite : M_Base
    {
        ...
        /// 选择的用户类型
        /// </summary>
        private string _a="<a data-toggle=\"dropdown\" class=\"dropdown-toggle\" href=\"javascript:void(0);\">{0} <b class=\"caret\"></b></a>";
        private string _li = "<li><a href=\"{0}\">{1}</a></li>";
        public StringBuilder sb=new StringBuilder(), _temp;
        protected void Page_Load(object sender, EventArgs e)
        {
                if (UserInfo != null)
                {
                    ...
                    foreach (var item in _p)
                    {
                        ...
                        _temp.AppendFormat(_a, item.IName).Append("<ul class=\"dropdown-menu\">");
