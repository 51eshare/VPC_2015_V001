...
namespace VPC_2014_V001.VPC.Vendor
{
    public partial class Pds : P_Base
    {
        ...
        private void loaddata()
        {
            ...
            _paging.Fields = "a.sImagePath,a.sPdName,a.sPdBrand,a.sPdStd,a.fPurPrice,b.sStatus,a.iPdId";
            ...
            _paging.Tables = @"tbProduct AS a INNER JOIN tbStatus AS b ON a.iStatus=b.iStatus AND b.StateType=1";
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (_commandname.Equals("up"))
            {
                if (new b_tbProduct().updateStatus(Int32.Parse(_iPdId.ToString()),DataState.passcheck))
                {
            ...
            {
                if (new b_tbProduct().updateStatus(Int32.Parse(_iPdId.ToString()), DataState.ban))
                {
                    tipclass = string.Empty;
                    message.Text = "操作成功！";
                    loaddata();
