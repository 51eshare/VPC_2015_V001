<%@ Page Title="咨询清单" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="VPC_2014_V001.VPC.Vendor.Messages" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row text-center">
                    ...
                    <a href="Question.aspx" class="btn btn-success">添加咨询</a>
                </div>
            </div>
            <!--list-->
                ...
                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a class='btn <%#bool.Parse(Eval("bApply").ToString())?"btn-success":"btn-danger" %>' href='Reply?iQuestionId=<%#Eval("iQuestionId")%>&urlreferrer=<%=StringEncode("/Vendor/Messages")%>&operate=view'><%#bool.Parse(Eval("bApply").ToString())?"查看":"查看" %></a>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </tbody>
