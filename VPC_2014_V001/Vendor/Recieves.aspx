<%@ Page Title="未签收清单" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="Recieves.aspx.cs" Inherits="VPC_2014_V001.VPC.Vendor.Recieves" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        ...
        <ItemTemplate>
                <tr >
                    ...
                    <td><%# DataBinder.Eval(Container.DataItem, "结算价") %><br /><%# DataBinder.Eval(Container.DataItem, "结算金额") %></td>
