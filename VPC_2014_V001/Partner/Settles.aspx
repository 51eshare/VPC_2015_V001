<%@ Page Title="未结算清单" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="Settles.aspx.cs" Inherits="VPC_2014_V001.VPC.Partner.Settles" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        ...
        <ItemTemplate>
                <tr >
                    ...
                    <td><%# DataBinder.Eval(Container.DataItem, "状态") %></td><br /><asp:Button ID="Button1" runat="server"  Text="查看" /></td>
