<%@ Page Title="订单详情" Language="C#" MasterPageFile="~/FullSite.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="VPC_2014_V001.VPC.Partner.Order" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dl class="dl-horizontal">
        ...
        <dt><a class="btn btn-primary" href="Orders.aspx">返回</a></dt>
      </dl>
    </form>
</asp:Content>
